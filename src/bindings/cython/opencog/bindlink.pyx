from opencog.atomspace cimport Atom, AtomSpace, TruthValue,  cHandle, cAtomSpace, cTruthValue
from opencog.atomspace cimport tv_ptr, strength_t, count_t, void_from_candle
